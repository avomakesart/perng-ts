...
let UserResolver = class UserResolver {
    changePassword(token, newPassword, { redis, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield User_1.Users.findOne(userIdNum);
            if (!user) {
                return {
                    errors: [
                        {
            ...
            yield User_1.Users.update({ id: userIdNum }, { password: yield argon2_1.default.hash(newPassword) });
            yield redis.del(key);
    ...
    forgotPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield User_1.Users.findOne({ where: { email } });
            if (!user) {
                return true;
            }
    ...
    me({ req }) {
        if (!req.session.userId)
            return null;
        return User_1.Users.findOne(req.session.userId);
    }
    ...
    login(usernameOrEmail, password, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield User_1.Users.findOne(usernameOrEmail.includes('@')
